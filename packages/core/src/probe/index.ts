 ...
 *
 * Present: probe interfaces, adapter registration, and the Next.js adapter.
 * Pending: the Express and Prisma adapters, the black box crawler, endpoint identity
 * normalization, the merge, and the structural diff.
 */
